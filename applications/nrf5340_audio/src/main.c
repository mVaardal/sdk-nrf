...
// K_THREAD_DEFINE(audio_lc3, 2048, audio_lc3_play, NULL, NULL, NULL, 7, 0,0);

K_THREAD_DEFINE(print_test, 8192, delete_this_func, NULL, NULL, NULL, 7, 0,0);
